...
- **Limits**: `intent_judge_timeout_sec` (6s). `num_ctx: 8192` (explicit). `max_tokens: 500` (canonical cap — OpenAI-compatible backends get it at the payload root; Ollama maps it to `num_predict`).
